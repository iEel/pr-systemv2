...
describe("PR list row actions", () => {
  ...
  test("PR Documents exposes a read-only board view with lifecycle quick actions", () => {
    ...
    expect(source).toContain('const activeBoardColumns: PRStatus[] = ["Draft", "Generated", "Printed"];');
    expect(source).toContain('const completedArchiveStatuses: ArchiveStatus[] = ["Signed", "Cancelled", "Reissued"];');
    expect(source).toContain("workflowRows");
    expect(source).toContain("archiveRows");
    expect(source).toContain("archiveStatus");
    expect(source).toContain("visibleArchiveRows");
    expect(source).toContain("Draft");
    expect(source).toContain("Generated");
    expect(source).toContain("Printed");
    expect(source).toContain("Signed");
    expect(source).toContain("Completed / Archived");
    expect(source).toContain("Latest Signed");
